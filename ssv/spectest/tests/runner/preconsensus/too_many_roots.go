	...
	return &tests.MultiMsgProcessingSpecTest{
		...
		Tests: []*tests.MsgProcessingSpecTest{
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgProposer(nil, testingutils.PreConsensusRandaoTooManyRootsMsgV(ks.Shares[1], 1, spec.DataVersionDeneb)),
				},
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgVoluntaryExit(nil, testingutils.PreConsensusVoluntaryExitTooManyRootsMsg(ks.Shares[1], 1)),
				},
				PostDutyRunnerStateRoot: "2ac409163b617c79a2a11d3919d6834d24c5c32f06113237a12afcf43e7757a0",
				OutputMessages: []*types.SignedPartialSignatureMessage{
