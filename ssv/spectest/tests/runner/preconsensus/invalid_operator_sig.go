...
func InvalidOperatorSignature() tests.SpecTest {
	...
	return &tests.MultiMsgProcessingSpecTest{
		Name: "pre consensus invalid operator signature",
		Tests: []*tests.MsgProcessingSpecTest{
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SignedSSVMessageWithSigner(1, ks.OperatorKeys[2], testingutils.SSVMsgAggregator(nil, testingutils.PreConsensusSelectionProofMsg(ks.Shares[1], ks.Shares[1], 1, 1))),
				},
