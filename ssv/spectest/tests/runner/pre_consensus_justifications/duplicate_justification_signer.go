...
func DuplicateJustificationSigner() tests.SpecTest {
	...
	expectedErr := "failed processing consensus message: invalid pre-consensus justification: duplicate signer"

	return &tests.MultiMsgProcessingSpecTest{
		Name: "pre consensus duplicate signer",
		Tests: []*tests.MsgProcessingSpecTest{
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgSyncCommitteeContribution(duplicateSignerAndPrepareMsg(testingutils.TestContributionProofWithJustificationsConsensusData(ks), testingutils.SyncCommitteeContributionMsgID), nil),
				},
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgAggregator(duplicateSignerAndPrepareMsg(testingutils.TestSelectionProofWithJustificationsConsensusData(ks), testingutils.AggregatorMsgID), nil),
				},
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgProposer(duplicateSignerAndPrepareMsg(testingutils.TestProposerWithJustificationsConsensusDataV(ks, spec.DataVersionDeneb), testingutils.ProposerMsgID), nil),
				},
			...
			},
			{
				...
				Duty:   testingutils.TestingProposerDutyV(spec.DataVersionDeneb),
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgProposer(duplicateSignerAndPrepareMsg(testingutils.TestProposerBlindedWithJustificationsConsensusDataV(ks, spec.DataVersionDeneb), testingutils.ProposerMsgID), nil),
				},
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgAttester(duplicateSignerAndPrepareMsg(testingutils.TestAttesterConsensusData, testingutils.AttesterMsgID), nil),
				},
			...
			},
			{
				...
				Messages: []*types.SSVMessage{
					testingutils.SSVMsgSyncCommittee(duplicateSignerAndPrepareMsg(testingutils.TestSyncCommitteeConsensusData, testingutils.SyncCommitteeMsgID), nil),
				},
