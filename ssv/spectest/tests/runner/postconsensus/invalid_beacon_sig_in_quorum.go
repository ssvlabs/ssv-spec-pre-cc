...
func InvalidBeaconSignatureInQuorum() tests.SpecTest {
	...
	return &tests.MultiMsgProcessingSpecTest{
		Name: "post consensus invalid beacon signature in quorum",
		Tests: []*tests.MsgProcessingSpecTest{
			...
			},
			{
				...
				Messages: []*types.SignedSSVMessage{
					testingutils.SignedSSVMessageF(ks, testingutils.SSVMsgProposer(nil, testingutils.PostConsensusWrongSigProposerMsgV(ks.Shares[1], 1, spec.DataVersionDeneb))),
